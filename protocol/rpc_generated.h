...
struct ForwardReadBarrierReply;
struct ForwardReadBarrierReplyBuilder;
...
inline const OperationCode (&EnumValuesOperationCode())[11] {
...
inline const char *EnumNameOperationCode(OperationCode e) {
  if (::flatbuffers::IsOutRange(e, OperationCode_UNKNOW, OperationCode_FORWARD_READ_BARRIER)) return "";
...
struct ForwardCliWrite FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const karma_rpc::Command *command() const {
    return GetPointer<const karma_rpc::Command *>(VT_COMMAND);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int64_t>(verifier, VT_FROM_ID, 8) &&
...
struct ForwardReadBarrier FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ForwardReadBarrierBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_FROM_ID = 4,
    VT_GROUP_ID = 6
  };
...
struct ForwardReadBarrierBuilder {
  typedef ForwardReadBarrier Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_from_id(int64_t from_id) {
    fbb_.AddElement<int64_t>(ForwardReadBarrier::VT_FROM_ID, from_id, -1LL);
  }
  void add_group_id(int64_t group_id) {
    fbb_.AddElement<int64_t>(ForwardReadBarrier::VT_GROUP_ID, group_id, -1LL);
  }
  explicit ForwardReadBarrierBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ForwardReadBarrier> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ForwardReadBarrier>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ForwardReadBarrier> CreateForwardReadBarrier(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int64_t from_id = -1LL,
    int64_t group_id = -1LL) {
  ForwardReadBarrierBuilder builder_(_fbb);
  builder_.add_group_id(group_id);
  builder_.add_from_id(from_id);
  return builder_.Finish();
}

struct ForwardReadBarrierReply FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ForwardReadBarrierReplyBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_FROM_ID = 4,
    VT_GROUP_ID = 6,
    VT_SUCCESS = 8,
...
struct ForwardReadBarrierReplyBuilder {
  typedef ForwardReadBarrierReply Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_from_id(int64_t from_id) {
    fbb_.AddElement<int64_t>(ForwardReadBarrierReply::VT_FROM_ID, from_id, -1LL);
  }
  void add_group_id(int64_t group_id) {
    fbb_.AddElement<int64_t>(ForwardReadBarrierReply::VT_GROUP_ID, group_id, -1LL);
  }
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(ForwardReadBarrierReply::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  void add_index(int64_t index) {
    fbb_.AddElement<int64_t>(ForwardReadBarrierReply::VT_INDEX, index, -1LL);
  }
  explicit ForwardReadBarrierReplyBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ForwardReadBarrierReply> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ForwardReadBarrierReply>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ForwardReadBarrierReply> CreateForwardReadBarrierReply(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int64_t from_id = -1LL,
    int64_t group_id = -1LL,
    bool success = false,
    int64_t index = -1LL) {
  ForwardReadBarrierReplyBuilder builder_(_fbb);
  builder_.add_index(index);
  builder_.add_group_id(group_id);
  builder_.add_from_id(from_id);
  builder_.add_success(success);
