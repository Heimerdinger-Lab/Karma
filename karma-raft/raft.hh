...
using log_entries = std::vector<log_entry_ptr>;
...
public:
    ...
    virtual co_context::task<snapshot_id> take_snapshot() = 0;
    ...
    virtual co_context::task<> load_snapshot(snapshot_id id) = 0;
...
public:
    ...
    virtual co_context::task<read_barrier_reply> execute_read_barrier_on_leader(server_id id) = 0;
    ...
    virtual co_context::task<add_entry_reply> send_add_entry(server_id id, const command& cmd) = 0;
...
public:
    ...
    virtual co_context::task<add_entry_reply> execute_add_entry(server_id from, command cmd) = 0;
...
public:
    ...
    virtual co_context::task<snapshot_descriptor> load_snapshot_descriptor() = 0;
    ...
    virtual co_context::task<log_entries> load_log() = 0;
