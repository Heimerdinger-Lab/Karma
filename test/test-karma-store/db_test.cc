...
// //                 io_uring_prep_write(sqe, 0, item->buf(), item->capacity(),
// item->wal_offset());
...
// //                 io_uring_prep_write(sqe, file.fd(), current->buf(), current->capacity(),
// current->wal_offset());
...
// //             // std::cout << "str2[0]: " << str2.data()[0] << ", " << str2.data()[1] <<
// str2.data()[2] << str2.data()[3] << std::endl;
...
//         //     std::cout << "wal_offset = " << result.m_wal_offset << ", size = " <<
//         result.m_size << std::endl;
//         // }
//         // BOOST_AUTO_TEST_CASE(build_sqe_test) {
//         //     // BOOST_CHECK(true);
//         //     open_options opt;
